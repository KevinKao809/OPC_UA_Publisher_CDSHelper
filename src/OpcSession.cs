        ...
        public async Task ConnectSession(CancellationToken ct)
        {
            try
            {
                ...
                try
                {
                    ...
                    // Add by Kevin Kao for handle UserIdentity
                    UserIdentity userIdentity = null;
                    switch (configuredEndpoint.SelectedUserTokenPolicy.TokenType)
                    {
                        case UserTokenType.UserName:
                            userIdentity = OpcUserIdentity.GetUserIdentity(configuredEndpoint.EndpointUrl.OriginalString);
                            break;
